...
export default function CrisisResourcesPage() {
  return (
    <>
      {/* Intro */}
      <section className="bg-white px-4 pb-10 pt-6 md:px-6 xl:px-8 md:pb-12 md:pt-8">
      ...
      <section
        ...
        className="bg-navy px-4 py-10 md:px-6 xl:px-8 md:py-12"
      >
        <div className="site-container grid items-center gap-8 lg:grid-cols-[auto_1fr_auto] lg:gap-12">
          <div
      ...
      <section className="bg-white px-4 py-14 md:px-6 xl:px-8 md:py-16">
        <div className="site-container">
      ...
      <section
        ...
        className="border-y border-border bg-[#EAF2FF] px-4 py-10 md:px-6 xl:px-8 md:py-12"
      >
        <div className="site-container flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-10">
          <div className="flex gap-4">
      ...
      <section
        ...
        className="bg-[#FDECEC] px-4 py-6 md:px-6 xl:px-8 md:py-7"
      >
        <div className="site-container flex gap-3 md:gap-4">
          <AlertTriangle
