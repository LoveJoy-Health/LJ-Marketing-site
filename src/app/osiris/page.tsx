...
export default function OsirisPage() {
  return (
    <>
      ...
      <section className="bg-atmosphere px-4 py-16 md:px-6 xl:px-8 md:py-20">
        <div className="site-container grid gap-10 md:grid-cols-2 md:items-start">
          <div>
      ...
      <section className="px-1 pb-2 md:px-1.5">
        <div className="overflow-hidden rounded-[2rem] bg-[#EDE6F8] px-4 py-14 md:rounded-[2.75rem] md:px-6 xl:px-8 md:py-16">
