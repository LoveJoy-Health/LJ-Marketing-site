...
export function Breadcrumbs() {
  ...
  return (
    <nav aria-label="Breadcrumb" className="px-3 pt-4 lg:px-4 md:pt-5">
      <ol className="mx-auto flex max-w-screen-2xl flex-wrap items-center gap-x-2 gap-y-1 text-sm text-navy/70">
